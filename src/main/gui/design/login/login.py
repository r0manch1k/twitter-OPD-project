...
"}")
        ...
        self.frame_Main = QFrame(form_Login)
...
"}")
        ...
        self.button_LogIn = QPushButton(self.frame_RegistrationWindowSub)
    ...
    def retranslateUi(self, form_Login):
        ...
        self.line_Login.setPlaceholderText(QCoreApplication.translate("form_Login", u"Login", None))
        ...
        self.label_FormatError.setText(QCoreApplication.translate("form_Login", u"Invalid suka", None))
